...
export const TicTacHome = ({navigation,route}) => {
  ...
  useEffect(()=>{
      ...
      RoomModel.listenAllRooms(getAllRoomSuccess)
        ...
        return (
            <View style={{width:'100%',height:80,borderWidth:1,backgroundColor:'white',borderRadius:20,justifyContent:'center',alignItems:'center'}}>
              ...
              <TouchableOpacity style={{justifyContent:'center',alignItems:'center'}}
                onPress={()=>{
                  RoomModel.enterRoom(item.room,userDocID)
                  setTimeout(()=>{
                    navigation.navigate({name:'TicTacToe',params:{room:item.room,emblem:'o'}})
                  },500)
                }}
              >
                <Text>เข้าร่วม
